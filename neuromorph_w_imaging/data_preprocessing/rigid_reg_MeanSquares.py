...
def f(fname, reference_fname, optimise=True):
    ...
    registration_method.SetOptimizerAsGradientDescent(learningRate=1.0, numberOfIterations=100, convergenceMinimumValue=1e-6, convergenceWindowSize=10)    # SPIE
...
def __main__():
    ...
    output_dir = join(output_dir, "to_" + reference_fname + "_MeanSquares")
