...
class NetParam(ParamBase):
    def __init__(self, lambd_imaging=1000):
        super().__init__()
        self.lr = 1e-4
        self.num_it = 70
        self.batch_size = 16
        ...
        self.lambd_geo = 50
        self.lambd_arap = 10
        self.lambd_imaging = lambd_imaging
...
def train_main(fold_num=1, lambd_imaging=1000):
    lambd_imaging = int(lambd_imaging)
    data_folder = ""
    ...
    interpol = create_interpol(fused_dataset_train, dataset_val=fused_dataset_val, description=f"imaging_loss_fold{fold_num}", folder_weights_load=None, param=NetParam(lambd_imaging=lambd_imaging))
    interpol.train()
