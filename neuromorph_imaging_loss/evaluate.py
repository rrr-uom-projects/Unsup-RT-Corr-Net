...
def calculate_metrics(sequence_fnames, results_folder, geodesic_dir, structure_name):
    geo_error = []
    chamfer_dists = []
    distort = []
...
for structure_name in ["brainstem", "spinal_cord", "mandible", "parotid", "submandibular"]:
    ...
    geo_error, chamfer_dists, distort = calculate_metrics(sequence_fnames, results_folder, geodesic_dir, structure_name)
    ...
    # John Legend
    obs_labels = ['all_oars', 'all_oars_w_imaging', 'all_oars_w_imaging_7_19_19']
    colors = ['m', 'xkcd:neon pink', 'xkcd:aquamarine']
    m_s = []
